...
class RaceFilters(BaseEntity):
    distance: List[str] | None = None
    surface: List[str] | None = None
    course: List[str] | None = None
    race_class: List[int | None] | None = None
    distance_beaten: List[int] | None = None


class InputRaceFilters(BaseEntity):
    race_id: int
    ...
    distance_beaten: str | None = None

    def get_distance_list(self) -> list[str]:
        return self.distance.split(",") if self.distance else []

    def get_surface_list(self) -> list[str]:
        return self.surface.split(",") if self.surface else []

    def get_course_list(self) -> list[str]:
        return self.course.split(",") if self.course else []

    def get_race_class_list(self) -> list[int]:
        return [int(self.race_class)] if self.race_class else []

    def get_distance_beaten_list(self) -> list[int]:
        return [int(self.distance_beaten)] if self.distance_beaten else []
...
class TodaysRaceFormData(BaseEntity):
    ...
    market_id_win: str | None = None
    market_id_place: str | None = None
