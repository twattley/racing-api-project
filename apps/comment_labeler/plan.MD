...
Train a local Gemma 3 27B model (`flat-hcap`) to label horse racing comments with 5 signals. Use a simple human-in-the-loop workflow: predict → review → retrain → repeat.
