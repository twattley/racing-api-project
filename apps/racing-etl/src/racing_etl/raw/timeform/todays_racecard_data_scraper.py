...
class TFRacecardsDataScraper(IDataScraper):
    ...
    def _get_horse_data(self, page: Page) -> pd.DataFrame:
        ...
        trainer_pattern = r"(?:https://www.timeform.com)?/horse-racing/trainer/([a-zA-Z-]+)/form/([0-9]+)"
        jockey_pattern = r"(?:https://www.timeform.com)?/horse-racing/jockey/([a-zA-Z-]+)/form/([0-9]+)"
